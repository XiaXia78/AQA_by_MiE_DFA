...
from PoseDetector2d.lib.yolov3.util import *
from PoseDetector2d.lib.yolov3.darknet import Darknet
from PoseDetector2d.lib.yolov3 import preprocess
...
def arg_parse():
    ...
    parser.add_argument('-wf', '--weight-file', type=str, default= 'F:/Pycharm/GCNTransformer/PoseDetector2d/lib/checkpoint/yolov3.weights', help='The path'
                        'of model weight file')

    # parser.add_argument('-wf', '--weight-file', type=str, default='demo/lib/yolov3/cfg/yolov3.cfg', help='The path'
    #                                                                                                          'of model weight file')
